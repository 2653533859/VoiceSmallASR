...
| Flutter 三端客户端（Windows/macOS/Android） | `app/` | **M1、M2、M3 已完成**：文件转写、实时字幕、视频播放与字幕联动（107 项 `flutter test` + 7 项 `integration_test`）。macOS 真实 mp4 已验收，Android/Windows 仍待验证 |
