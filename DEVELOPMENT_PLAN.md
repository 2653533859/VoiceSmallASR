...
- [x] API 35 ARM64 模拟器基线：M10 统一入口已通过模型下载、完整性校验和 `yue.wav` 文件识别，2 线程文件 RTF `0.026612`，模型目录约 241 MB，模型准备后 RSS 当前约 403 MiB、峰值约 447 MiB；视频和麦克风因未提供参数明确跳过，详细数据见 [`M10_DEVICE_ACCEPTANCE.md`](M10_DEVICE_ACCEPTANCE.md)，该结果不替代真机验收
