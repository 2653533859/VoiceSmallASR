...
M20 当前已在 macOS Apple Silicon 完成 1 小时合成视频的连续分块音轨解码、播放器推进、播放列表切换、播放器语义 widget 回归，以及应用暂停/恢复时的字幕检查点回归；详细结果与复现命令见 [`M20_DEVICE_ACCEPTANCE.md`](M20_DEVICE_ACCEPTANCE.md)。Android 真机、Windows 用户桌面、真实 macOS 睡眠唤醒和辅助功能检查器仍待验收。
